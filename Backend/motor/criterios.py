...
VERIFICACIONES: dict[str, Verificacion] = {
    ...
    for v in (
        ...
        Verificacion("tecnica.mipyme", "tecnica", 127, "MIPYME", "MIPYME domiciliada en Colombia",
                     ...
                     "puntaje", ("rup", "mipyme")),
        Verificacion("tecnica.maquinaria", "tecnica", 128, "Maquinaria", "Disponibilidad y condiciones de la maquinaria de obra",
                     "Solo si el pliego da puntos por este factor; si dice NO APLICA, no se evalúa.", "puntaje",
                     ("maquinaria", "formato 7")),
