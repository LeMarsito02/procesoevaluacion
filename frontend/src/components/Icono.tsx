/** Íconos de trazo (estilo Lucide), en línea para no depender de paquetes. */
const TRAZOS = {
  ...
  ojo: 'M2 12s3.6-7 10-7 10 7 10 7-3.6 7-10 7S2 12 2 12zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z',
  deshacer: 'M3 7v6h6M3.5 13A9 9 0 1 0 6 6.3L3 9',
  reloj: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM12 6v6l4 2',
  chispa: 'M12 3l1.9 5.8L20 11l-6.1 2.2L12 19l-1.9-5.8L4 11l6.1-2.2z',
...
export default function Icono({ nombre, tam = 18, grosor = 2 }: { nombre: NombreIcono; tam?: number; grosor?: number }) {
  return (
    <svg
      width={tam}
      height={tam}
